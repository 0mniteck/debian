...
RUN sed -i 's,http://deb.debian.org/debian-security,http://snapshot.debian.org/archive/debian-security/20241109T084744Z,g' /etc/apt/sources.list.d/debian.sources
RUN sed -i 's,http://deb.debian.org/debian,http://snapshot.debian.org/archive/debian/20241109T082826Z,g' /etc/apt/sources.list.d/debian.sources
...
RUN sed -i 's,http://snapshot.debian.org/archive/debian-security/20241109T084744Z,https://snapshot.debian.org/archive/debian-security/20241109T084744Z,g' /etc/apt/sources.list.d/debian.sources
RUN sed -i 's,http://snapshot.debian.org/archive/debian/20241109T082826Z,https://snapshot.debian.org/archive/debian/20241109T082826Z,g' /etc/apt/sources.list.d/debian.sources
